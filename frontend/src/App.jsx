...
function App() {
  ...
  useEffect(() => {
    if (!isCameraActive || currentPage !== 'home') {
  ...
  }, [isCameraActive, selectedExercise, currentPage])
  ...
  return (
    <div className="app-container">
        ...
        <nav>
          <ul className="nav-links">
            <li>
              <a 
                href="#home" 
                className={`nav-link ${activeTab === 'home' && currentPage === 'home' ? 'active' : ''}`}
                onClick={() => {
                  navigateToHome()
                  setActiveTab('home')
                }}
            ...
            <li>
              <a 
                href="#features" 
                className={`nav-link ${activeTab === 'features' && currentPage === 'home' ? 'active' : ''}`}
                onClick={() => {
                  navigateToHome()
            ...
            <li>
              <a 
                href="#pose-coach" 
                className={`nav-link ${activeTab === 'coach' && currentPage === 'home' ? 'active' : ''}`}
                onClick={() => {
                  navigateToHome()
                  setActiveTab('coach')
                }}
            ...
            <li>
              <a 
                href="#testimonials" 
                className={`nav-link ${activeTab === 'testimonials' && currentPage === 'home' ? 'active' : ''}`}
                onClick={() => {
                  navigateToHome()
      ...
      {currentPage === 'home' ? (
        ...
        /* PREMIUM LOGIN & REGISTER SECTION */
          ...
          <div className="auth-wrapper">
            ...
            <div className="auth-info-pane">
              ...
              <div>
                <h2 className="auth-info-title">
                  Bắt đầu ngay<br />
                  cùng <span>AIFitness</span>
                </h2>
                <p className="auth-info-desc">
                  Kiểm soát tuyệt đối tư thế, mở rộng giới hạn bản thân với huấn luyện viên AI chuyên biệt dành riêng cho bạn.
                </p>
                
                <ul className="auth-benefits">
                  <li className="benefit-item">
                    <span className="benefit-bullet">✓</span>
                    Chỉnh sửa tư thế chuẩn xác thời gian thực
                  </li>
                  <li className="benefit-item">
                    <span className="benefit-bullet">✓</span>
                    Đếm số reps tự động bằng camera điện thoại
                  </li>
                  <li className="benefit-item">
                    <span className="benefit-bullet">✓</span>
                    Thiết lập giáo án tập luyện tối ưu 100%
                  </li>
                </ul>
              </div>
              
              <div style={{ fontSize: '12px', color: 'var(--text-main)', marginTop: '20px' }}>
                Hỗ trợ kỹ thuật 24/7 • Đồ án tốt nghiệp 2026
              </div>
            </div>
            ...
            <div className="auth-form-pane">
              ...
              <div className="auth-social-buttons">
                <button className="social-login-btn" title="Google">G</button>
                <button className="social-login-btn" title="Discord">D</button>
                <button className="social-login-btn" title="Apple">A</button>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="footer-links-grid">
            <div className="footer-links-col">
              ...
              <ul className="footer-links-list">
                <li><a href="#pose-coach" onClick={navigateToHome} className="footer-link">AI Pose Coach</a></li>
                <li><a href="#features" onClick={navigateToHome} className="footer-link">Custom Routine</a></li>
                <li><a href="#home" onClick={navigateToHome} className="footer-link">Personal Plan</a></li>
              </ul>
            </div>
